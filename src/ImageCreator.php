...
class ImageCreator
{
    ...
    public function __construct(
        ...
        $this->ima = imagecreatetruecolor(600, 200);
    ...
    {
        return imagecolorallocate($this->ima, ...$rgb);
    }
    ...
    public function createImage(): void
    {
        ...
        imagefilledrectangle($this->ima, 0, 0, 600, 200, $this->yourColor);
        imagefilledrectangle($this->ima, 10, 10, 590, 190, $this->yourColor2);

        // Ajout du texte
        imagettftext($this->ima, 20, 0, 50, 50, $this->white, $this->font, $this->text);
        imagettftext($this->ima, 12, 0, 50, 80, $this->white, $this->font, $this->text2);

        // Sauvegarde l'image
        imagepng($this->ima);
        imagedestroy($this->ima);
    }
}
